...
def load_templates(template_dir, negative_template_dir):
    ...
    for filename in os.listdir(template_dir):
        if filename.endswith('.png'):
            ...
            template = cv2.imread(path, cv2.IMREAD_GRAYSCALE)  # Convert directly to grayscale
            if template is None:
                continue
...
def match_mouse(frame, templates, negative_templates, last_loc, search_window_size, threshold_min, threshold_max, overlap_threshold, r = 0):
    ...
    return match_mouse(frame, templates, negative_templates, None, None, threshold_min, threshold_max, overlap_threshold, 1)
    

def process_video(video_path, template_dir, negative_template_dir, output_dir, threshold_min, threshold_max, overlap_threshold, search_window_size):
...
process_video(video_path, template_dir, negative_template_dir, output_dir, threshold_min, threshold_max, overlap_threshold, search_window_size)